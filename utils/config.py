...
if cp_data:
    if version == 'v2':
        cache_root          = '/data/jxq/GenB_data/cp-cache/'
    else:
        cache_root = '/data/jxq/GenB_data/cpv1-cache/'
elif version == 'ok':
    cache_root = '/data/jxq/GenB_data/ok-cache/'
else:
    cache_root          = '/data/jxq/GenB_data/cache/'
