...
from modules.base_model_MCD import GenB
...
if __name__ == '__main__':
    ...
    if config.version=='v2':
        ...
        genb.w_emb.init_embedding('../glove6b_init_300d.npy')
    else:
        model.w_emb.init_embedding('../glove6b_init_300d_v1.npy')
        genb.w_emb.init_embedding('../glove6b_init_300d_v1.npy')
    ...
    if args.test_only or args.eval_only:
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            tb_count = train(model, metric_fc, genb, discriminator, optim, optim_G, optim_D, train_loader, loss_fn, tracker, writer, tb_count, epoch, args)
